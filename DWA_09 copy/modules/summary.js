...
class BookCard extends HTMLElement {
  ...
  // Add event specifically to button
  connectedCallback() {
    this.shadow.querySelector('[data-list-button]').addEventListener('click', this.openSummary);
  }

  // disconnectedCallback() {
  //   this.shadow.querySelector('[data-list-active]').removeEventListener('click',);
  // }
}
